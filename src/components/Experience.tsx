            ...
            <div className="w-full max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 md:mr-12">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Frontend Engineer</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 md:ml-12">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">Mahakal Institute of Technology and Management, RGPV</p>
                    <p className="text-gray-600 dark:text-gray-400">CGPA: 7.55 • 2018-22</p>
                  </div>
                  
                  <div>
                    <h4 className="text-xl font-semibold text-blue-600">Higher Secondary</h4>
                    <p className="text-gray-700 dark:text-gray-300">Jawahar Navodaya Vidhyalaya, CBSE</p>
                    <p className="text-gray-600 dark:text-gray-400">Result: 75% • 2018</p>
                  </div>
                </div>
              </div>
            </div>
