...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 px-4 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <a href="mailto:sachinpatidar413@gmail.com" className="text-gray-600 hover:text-purple-600 transition-colors duration-200">
              ...
              <div className="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <a href="tel:+919589005828" className="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                    +91 9589005828
                  </a>
                </div>
              </div>
            ...
            <div className="flex space-x-4 pt-6">
              <a
                ...
                className="p-3 bg-gray-800 text-white rounded-full hover:bg-gray-700 transition-all duration-300 hover:scale-110"
              >
