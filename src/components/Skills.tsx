...
const Skills = () => {
  ...
  const skills = [
    ...
    { name: "TypeScript", icon: "TS", color: "from-blue-500 to-blue-700", level: 85 },
    { name: "React", icon: "⚛", color: "from-cyan-400 to-blue-500", level: 95 },
    { name: "Next.js", icon: "N", color: "from-gray-700 to-black", level: 80 },
    { name: "Redux", icon: "RX", color: "from-purple-500 to-indigo-600", level: 75 },
    { name: "Tailwind CSS", icon: "TW", color: "from-teal-400 to-cyan-500", level: 90 },
    { name: "Node.js", icon: "NODE", color: "from-green-500 to-green-700", level: 70 },
    { name: "MongoDB", icon: "DB", color: "from-green-400 to-teal-600", level: 65 },
    { name: "GSAP", icon: "GS", color: "from-green-400 to-lime-500", level: 80 },
    { name: "Framer Motion", icon: "FM", color: "from-pink-500 to-rose-600", level: 85 },
    { name: "SASS", icon: "S", color: "from-pink-400 to-red-500", level: 88 },
    { name: "Bootstrap", icon: "B", color: "from-purple-600 to-blue-700", level: 92 }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-20">
          <div className="relative min-h-[500px] bg-gradient-to-br from-gray-900 to-purple-900 dark:from-gray-800 dark:to-purple-800 rounded-3xl overflow-hidden p-8">
            ...
            {/* Skill Bubbles */}
            <div className="relative z-10 flex flex-wrap justify-center items-center gap-4 min-h-[400px]">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Hover tooltip */}
                      <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-black/80 text-white px-3 py-1 rounded-lg text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap z-20">
        ...
        {/* Certifications */}
        <div>
          <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-6 text-center">Certifications</h3>
